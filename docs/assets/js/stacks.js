...
(function () {
    "use strict";
    Stacks.addController("s-sortable-table", {
        ...
        setCurrentSort: function (headElem, direction) {
            ...
            this.columnTargets.forEach(function (target) {
                ...
                if (!isCurrrent || direction === "none") {
                    target.removeAttribute("data-sort-direction");
                } else {
                    target.setAttribute("data-sort-direction", direction);
                }
            });
        },
        ...
        sort: function (evt) {
            ...
            var direction = colHead.getAttribute("data-sort-direction") === "asc" ? -1 : 1;
