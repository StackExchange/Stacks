...
export class TooltipController extends BasePopoverController {
    ...
    show(dispatcher: Event|Element|null = null) {
        ...
        var controller = application.getControllerForElementAndIdentifier(this.element, "s-popover");
...
function applyOptionsAndTitleAttributes(element: Element, options?: TooltipOptions) {
    ...
    var controller = <TooltipController>application.getControllerForElementAndIdentifier(element, "s-tooltip");
