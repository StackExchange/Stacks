            ...
            <tr>
              ...
              <td class="va-middle">
                <div class="d-flex g4 fw-wrap">
                  ...
                  {/if}
                  <code class="stacks-code">.s-btn__dropdown</code>
                </div>
              </td>
              <td class="va-middle ta-center px4">
                <Button class="ws-nowrap" {variant} {weight} dropdown>Ask question</Button>
              </td>
              <td class="va-middle ta-center px4">
                <Button class="ws-nowrap" {variant} {weight} dropdown selected aria-pressed="true">Ask question</Button>
              </td>
              <td class="va-middle ta-center px4">
                <Button class="ws-nowrap" {variant} {weight} dropdown disabled>Ask question</Button>
              </td>
            </tr>
          {/if}
        {/each}
