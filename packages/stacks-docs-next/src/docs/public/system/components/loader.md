    ...
    <table class="docs-table s-table s-table__bx-simple">
        ...
        <tbody class="fs-caption">
                ...
                <tr>
                        ...
                        <td>Base class for the loader component</td>
                ...
                <tr>
                        ...
                        <td>Necessary to render the center loader block and renders the accessible text</td>
                ...
                <tr>
                        ...
                        <td>A small variant of the loader component</td>
                ...
                <tr>
                        ...
                        <td>A large variant of the loader component</td>
    ...
    <table class="docs-table s-table s-table__bx-simple">
        ...
        <tbody class="fs-caption">
                ...
                <tr>
                        ...
                        <td><div class="s-loader s-loader__sm"><div class="s-loader--sr-text">Loading…</div></div></td>
                ...
                <tr>
                        ...
                        <td><div class="s-loader"><div class="s-loader--sr-text">Loading…</div></div></td>
                ...
                <tr>
                        ...
                        <td><div class="s-loader s-loader__lg"><div class="s-loader--sr-text">Loading…</div></div></td>
...
<!-- Reset all default values -->
            ...
            <!-- <div class="d-flex my48 pt24">
                <div class="mr16">
                    ...
                    <form
                        id="quick-positive-feedback-loader"
                        class="js-feedback-form v-hidden"
                        name="quick-positive-feedback-loader"
                        method="POST"
                        data-netlify="true"
                        action="/success">
                    </form>
                    <form
                        id="quick-negative-feedback-loader"
                        class="js-feedback-form v-hidden"
                        name="quick-negative-feedback-loader"
                        method="POST"
                        data-netlify="true"
                        action="/success">
                    </form>
                    ...
                    <div id="vote-feedback" class="s-vote">
                        <button
                            class="s-vote--btn"
                            type="submit"
                            form="quick-positive-feedback-loader"
                        ...
                        <button
                            class="s-vote--btn"
                            type="submit"
                            form="quick-negative-feedback-loader"
                    ...
                    <fieldset class="d-flex fd-column fl-grow1 g16">
                        ...
                        <div class="d-flex ai-center fd-row-reverse g8 jc-space-between mln6 sm:d-grid sm:grid__1 sm:ml0">
                            ...
                            <div class="d-flex fw-wrap g8 sm:d-grid sm:grid__1">
                                <a
                                    href="https://github.com/StackExchange/Stacks/edit/develop/packages/stacks-docs/./product/components/loader.html"
