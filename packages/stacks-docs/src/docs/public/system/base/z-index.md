...
<script lang="ts">
    ...
    const classes: ClassTableRow[] = [
        { class: '.z-hide',      output: 'z-index: -1;'    },
        { class: '.z-base',      output: 'z-index: 0;'     },
        { class: '.z-selected',  output: 'z-index: 25;'    },
        { class: '.z-active',    output: 'z-index: 50;'    },
        { class: '.z-dropdown',  output: 'z-index: 1000;'  },
        { class: '.z-popover',   output: 'z-index: 2000;'  },
        { class: '.z-tooltip',   output: 'z-index: 3000;'  },
        { class: '.z-banner',    output: 'z-index: 4000;'  },
        { class: '.z-nav',       output: 'z-index: 5000;'  },
        { class: '.z-nav-fixed', output: 'z-index: 5050;'  },
        { class: '.z-modal-bg',  output: 'z-index: 8050;'  },
        { class: '.z-modal',     output: 'z-index: 9000;'  },
    ];
</script>
...
<Example>
    <div class="ps-relative fs-caption ff-mono overflow-x-auto" style="height: 552px;">
