<script lang="ts">
    ...
    // Preferred ordering only; any other category is appended so a new
    // template is never silently dropped from the sidebar.
...
<aside class="ws2 fl-shrink0 sm:w100 ba bc-black-200 bg-white">
    <header class="p16 bb bc-black-200">
        ...
        <p class="m0 mt4 fs-caption fc-black-500">
            A collection of Stack Overflow authored email templates. <a
                class="s-link"
                href="https://stackoverflow.design/email"
    ...
    <div class="p12 overflow-y-auto sm:h-auto">
        {#each templateGroups as group (group.category)}
            <p
                class="m0 mt12 mb4 px8 fs-caption tt-uppercase fc-black-400 fw-bold"
            >
                {group.category}
            </p>
            <Navigation
