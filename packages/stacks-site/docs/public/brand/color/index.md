...
<script>
  import ColorHierarchy from './ColorHierarchy.svelte'
  import ColorCodes from './ColorCodes.svelte'
  import ColorBusinessProduct from './ColorBusinessProduct.svelte'
  import ColorBackgrounds from './ColorBackgrounds.svelte'
